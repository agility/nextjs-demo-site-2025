...
This guide provides instance-specific information for content editors working with the Demo Site. For generic Agility CMS concepts and workflows, see the [Generic Training Guide](../generic/README.md).
...
1. **Review Generic Training**: Start with the [Generic Training Guide](../generic/README.md) to understand Agility CMS concepts
