...
```markdown
![Alt text describing the screenshot](./screenshots/website/01-homepage.jpeg)
```
...
**Content Section:**
```markdown
![Content Section Overview](./screenshots/agility-cms/02-content-section-overview.png)
```
...
![Content Item Edit View](./screenshots/agility-cms/12-content-item-edit.png)
```
...
![Page Edit View](./screenshots/agility-cms/13-page-edit-view.png)
```
...
**Component Structure:**
```markdown
![Components Section](./screenshots/agility-cms/10-components-section.png)

All components must be registered in the frontend code.

![Component Definition](./screenshots/agility-cms/14-component-definition.png)
```

**Website Examples:**
```markdown
![Homepage](./screenshots/website/01-homepage.jpeg)

The homepage demonstrates multiple components working together.

![Blog Listing](./screenshots/website/06-blog-listing.png)
...
**Content Models:**
```markdown
![Content Section](./screenshots/agility-cms/02-content-section-overview.png)
...
**Asset Management:**
```markdown
![Assets Section](./screenshots/agility-cms/11-assets-section.png)
...
1. **Descriptive Alt Text**: Always include meaningful alt text
   ```markdown
   ![Agility CMS Dashboard showing main navigation](./screenshots/agility-cms/01-dashboard-home.png)
   ```
...
4. **Sequence Screenshots**: Show workflows with multiple screenshots
   ...
   ![Pages Section](./screenshots/agility-cms/08-pages-section.png)
...
- [ ] Path is relative (starts with `./screenshots/`)
...
*For more information, see [Screenshots README](./screenshots/README.md)*
