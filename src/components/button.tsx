...
const variants = {
  primary: clsx(
    ...
    'data-disabled:bg-gray-950 data-disabled:opacity-40 data-hover:bg-gray-800 transition-colors',
  ),
  secondary: clsx(
    ...
    'data-disabled:bg-white/15 data-disabled:opacity-40 data-hover:bg-white/40 transition-colors',
  ),
  outline: clsx(
    ...
    'data-disabled:bg-transparent data-disabled:opacity-40 data-hover:bg-gray-50 transition-colors',
  ),
}
