...
interface PersonalizedBackgroundHeroClientProps {
  heading: string
  description: string
  cta1?: URLField
  cta2?: URLField
...
export const PersonalizedBackgroundHeroClient = ({
  heading,
  description,
  cta1,
  cta2,
  ...
  backgroundImage,
  contentID,
}: PersonalizedBackgroundHeroClientProps) => {
  return (
    <div className="relative -mt-36 z-0" data-agility-component={contentID}>
      ...
      <Container className="relative">
        <div className="pt-48 pb-24 sm:pt-52 sm:pb-32 md:pt-64 md:pb-48">
          <h1
            className={clsx(
              "font-display text-6xl/[0.9] font-medium tracking-tight text-balance sm:text-8xl/[0.8] md:text-9xl/[0.8]",
          ...
          <p
            className={clsx(
              "mt-8 max-w-lg text-xl/7 font-medium sm:text-2xl/8",
              backgroundType === "background-image"
