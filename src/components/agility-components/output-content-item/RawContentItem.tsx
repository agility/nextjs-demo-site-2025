		...
		<>
			<h3 className="text-lg font-medium text-gray-600 pt-6">
				...
				>
					...
					<FaCaretDown className={clsx("transition-transform", jsonExpanded ? "rotate-0" : "-rotate-90")} />
				</button>
			</h3>
			<div className={clsx("overflow-hidden transition-all", !jsonExpanded ? "h-0" : "h-auto")}>
				<pre
					className={clsx(
